...
**Due: Friday 4 Mar 2022 by 11:59pm**

------------------------------------------------------------------------

![Pacmanmaze](https://inst.eecs.berkeley.edu/~cs188/fa21/assets/images/pacman_multi_agent.png)
...
environment as described in [Project 0](https://github.com/williamdemeo/cs370-spring2022/tree/master/projects/Project0)
...
`submission_autograder.py`. Please *do not* change
...
-   +1 if your games take on average less than 30 seconds on the
    ...
    `--no-graphics`. The autograder is run on EC2,
